			...
			<div className="navbar">
				<ul className="nav nav-tabs">
					<li onClick={() => props.handlePageChange("Dashboard")}
						...
						<a>Dashboard<span style={{'fontSize':'16px'}} className="pull-right hidden-xs showopacity fa fa-line-chart"></span></a>
					</li>
					
					<li onClick={() => props.handlePageChange("Customers")}
						className = {props.currentPage === "Customers" ? "active" : ""}>
						<a>Customers<span style={{'fontSize':'16px'}} className="pull-right hidden-xs showopacity fa fa-users"></span></a>
					</li>
					
					<li  onClick={() => props.handlePageChange("Products")}
						className = {props.currentPage === "Products" ? "active" : ""}>
							<a>Products<span style={{'fontSize':'16px'}}  className="pull-right hidden-xs showopacity fa fa-database"></span></a>
					</li>
					
					<li onClick={() => props.handlePageChange("Sales")}
						className = {props.currentPage === "Sales" ? "active" : ""} >
							<a>Sales<span style={{'fontSize':'16px'}} className="pull-right hidden-xs showopacity fa fa-money"></span></a>
					</li>
					
					<li onClick={() => props.handlePageChange("Schedule")}
						className = {props.currentPage === "Schedule" ? "active" : ""} >
							<a>Schedule<span style={{'fontSize':'16px'}} className="pull-right hidden-xs showopacity fa fa-calendar"></span></a>
					</li>
					...
					<li onClick={() => {
						...
						<a>Log Out<span style={{'fontSize':'16px'}} className="pull-right hidden-xs showopacity fa fa-sign-out"></span></a>
					</li> 			
