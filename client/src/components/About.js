      ...
      <Row className="wow fadeInUp">
        ...
        <Col size="xs-8">
          ...
          <p>
            ...
            the attention of generations around the world sparked my nonstop
      ...
      <Row className="wow fadeInUp">
        ...
        <Col size="xs-8">
          ...
          <p>
            ...
            starting a website were a necessity. I then became interested in the
            possibilities that web development held for me not only as a
