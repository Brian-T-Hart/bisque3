        ...
        {/* Row #1 */}
          ...
          <Row className="wow fadeInUp">
            ...
            <Col size="xs-8">
              ...
              <p>
                ...
                150-year-old denim brand aged so gracefully and continuously
                caught the attention of generations around the world sparked my
                nonstop quest in testing brand and marketing tactics.{" "}
              </p>
            </Col>
          </Row>
          ...
          <Row className="wow fadeInUp">
            ...
            <Col size="xs-8">
              ...
              <p>
                ...
                client-friendly functions that will expand your website’s
                influence and increase your web conversions. Strong multitasking,
                project management skills, and high level of attention to details.
              </p>
            </Col>
          </Row>
          ...
          <Row className="wow fadeInUp">
            ...
            <Col size="xs-8">
              ...
              <p>
                ...
                possible to record music in your bedroom. Once I got comfortable
                with using a DAW, the necessary skills to troubleshooting and
                starting a website were a necessity. I then became interested in
                the possibilities that web development held for me not only as a
          ...
          <Row className="wow fadeInUp">
            ...
            <Col size="xs-8">
              ...
              <p>
                I currently teach Algebra, Physics, and Robotics. I have been
                teaching at my current school for 11 years.
              </p>
            </Col>
          </Row>
          ...
          <Row className="wow fadeInUp">
            ...
            <Col size="xs-8">
              ...
              <p>
                Full stack web developer skilled in creating web applications
                using front and backend technologies and multiple languagues.
                Other relevant skills include Public Speaking, Microsoft
                Powerpoint Presentations, and leadership capabilities. Strong
                engineering professional with a Bachelor of Science (B.S.) focused
                in Applied Mathematics from California State University, Long
                Beach.
              </p>
            </Col>
          </Row>
